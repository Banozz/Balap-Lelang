<nav x-data="{ open: false }" class="bg-gray-100 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 p-3 shadow">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-12 justify-between">
            ...
            <div class="flex items-center">
                <!-- Logo -->
                <div class="shrink-0">
                    <a href="{{ route('index') }}" class="text-xl font-bold text-gray-800 dark:text-gray-200">
                        BalapLelang
                    </a>
                </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-10 space-x-4">
                    <div class="flex space-x-1">
                        <input type="text" placeholder="Search" class="px-4 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-black dark:focus:ring-white dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600">
                    ...
                    <a href="{{ auth()->check() && auth()->user()->usertype == 'seller' ? route('cars.create') : route('register') }}" 
                        class="inline-block bg-blue-500 text-white px-4 py-2 rounded-xl">
                        Sell your car!
                    </a>
                    @auth
